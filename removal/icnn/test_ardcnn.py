...
def get_all():
    ...
    images = '/home/zx/repo/dataset/rain_test/allover/'
    ...
    weights = '../model/ard_weights.36_0.00303.hdf5'
    ...
    for i, img in enumerate(out):
        ...
        #cv2.imwrite('../result/ardcnn_all/%05d.png' % i, img)
        cv2.imwrite('/home/zx/repo/dataset/rain_result/ours/allover/mask/%05d.png' % i, img)
