...
def test(icnn, ardcnn, model):
    ...
    rain_img = misc.imread('repo/dataset/rain_test/cityscapes_small/406_0_B.png')
    edge_img = misc.imread('repo/dataset/rain_test/cityscapes_small/406_0_E.png')
...
if __name__ == '__main__':
    ...
    icnn_model.load_weights('../model/icnn_weights.50_0.00670.hdf5')
    ardcnn_model.load_weights('../model/ard.40_0.00585.hdf5')
    freeze(icnn_model)
    freeze(ardcnn_model)
    ...
    callbacks = [keras.callbacks.TensorBoard(log_dir='../log/'),
                 keras.callbacks.ModelCheckpoint('../model/full.{epoch:02d}_{loss:.5f}.hdf5',
                                                'loss',
